 ...
 */
class TokenAuthComposite extends PayPalCompositeBase
{
	...
	public function build(array $buildSubject)
	{
		...
		$this->logger->logInfo(1, "Initiating PayPal Token Auth Transaction", "Order ID: " . $orderIncrementId);

		// Get PayPal order ID as reference order ID
		$token = $payment->getAdditionalInformation(DataAssignObserver::REF_TXN_KEY);

		// For token auth, operation type is AUTHORIZE
