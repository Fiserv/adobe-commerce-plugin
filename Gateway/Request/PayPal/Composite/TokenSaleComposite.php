 ...
 */
class TokenSaleComposite extends PayPalCompositeBase
{
	...
	public function build(array $buildSubject)
	{
		...
		$this->logger->logInfo(1, "Initiating PayPal Token Sale Transaction", "Order ID: " . $orderIncrementId);

		// Get token as reference order ID
		$token = $payment->getAdditionalInformation(DataAssignObserver::REF_TXN_KEY);

		// For token sale, operation type is CAPTURE
