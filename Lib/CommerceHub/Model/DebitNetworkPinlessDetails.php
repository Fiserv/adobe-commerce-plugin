...
class DebitNetworkPinlessDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $debit_network_id Identifies the debit network
     *
     * @return self
     */
    public function setDebitNetworkId($debit_network_id)
    {
        ...
        if ((mb_strlen($debit_network_id) > 20)) {
     ...
     * Sets pinless_pos
     *
     * @param string|null $pinless_pos PINless POS indicator.
     *
     * @return self
     */
     ...
     *
     * @param string|null $pinless_bill_pay PINless BillPay indicator.
     *
     * @return self
     */
    public function setPinlessBillPay($pinless_bill_pay)
    {
        ...
        if ((mb_strlen($pinless_bill_pay) > 13)) {
     ...
     * Sets e_commerce
     *
     * @param string|null $e_commerce e-Commerce indicator.
     *
     * @return self
     */
     ...
     * Sets dual_indicator
     *
     * @param string|null $dual_indicator Dual indicator.
     *
     * @return self
     */
    public function setDualIndicator($dual_indicator)
    {
        ...
        if ((mb_strlen($dual_indicator) > 13)) {
     ...
     * Sets pinned_pos
     *
     * @param string|null $pinned_pos Pinned POS indicator.
     *
     * @return self
     */
