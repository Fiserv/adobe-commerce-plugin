...
class KeyValuePair implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key Key for the custom information.
     *
     * @return self
     */
    public function setKey($key)
    {
        if (!is_null($key) && (mb_strlen($key) > 256)) {
            throw new \InvalidArgumentException('invalid length for $key when calling KeyValuePair., must be smaller than or equal to 256.');
        }
     ...
     * Sets value
     *
     * @param string|null $value Value for the custom information.
     *
     * @return self
     */
    public function setValue($value)
    {
        if (!is_null($value) && (mb_strlen($value) > 256)) {
            throw new \InvalidArgumentException('invalid length for $value when calling KeyValuePair., must be smaller than or equal to 256.');
        }
