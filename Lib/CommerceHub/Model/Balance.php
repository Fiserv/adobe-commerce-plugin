 ...
 *
 * @category Class
 * @description &lt;a href&#x3D;\&quot;../docs/?path&#x3D;docs/Resources/API-Documents/Payments_VAS/Balance-Inquiry.md\&quot;&gt;Balance&lt;/a&gt; object to support account balances.
 * @package  Fiserv\Payments\Lib\CommerceHub
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Balance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['currency']) && !preg_match("/^[A-Z]+$/", $this->container['currency'])) {
            $invalidProperties[] = "invalid value for 'currency', must be conform to the pattern /^[A-Z]+$/.";
        }

        if (!is_null($this->container['balance_type']) && (mb_strlen($this->container['balance_type']) > 17)) {
            $invalidProperties[] = "invalid value for 'balance_type', the character length must be smaller than or equal to 17.";
        }
     ...
     *
     * @param float|null $beginning_balance Account beginning balance.
     *
     * @return self
     */
    public function setBeginningBalance($beginning_balance)
    {
        ...
        if (($beginning_balance > 1.0E+18)) {
            throw new \InvalidArgumentException('invalid value for $beginning_balance when calling Balance., must be smaller than or equal to 1.0E+18.');
        }
     ...
     * Sets ending_balance
     *
     * @param float|null $ending_balance Account ending balance.
     *
     * @return self
     */
    public function setEndingBalance($ending_balance)
    {
        ...
        if (($ending_balance > 1.0E+18)) {
            throw new \InvalidArgumentException('invalid value for $ending_balance when calling Balance., must be smaller than or equal to 1.0E+18.');
        }
     ...
     * Sets currency
     *
     * @param string|null $currency ISO 3 Currency Format.
     *
     * @return self
     */
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling Balance., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]+$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling Balance., must conform to the pattern /^[A-Z]+$/.");
        }
     ...
     * Sets balance_type
     *
     * @param string|null $balance_type Indicates type of account balance represents.
     *
     * @return self
     */
    public function setBalanceType($balance_type)
    {
        ...
        if ((mb_strlen($balance_type) > 17)) {
            throw new \InvalidArgumentException('invalid length for $balance_type when calling Balance., must be smaller than or equal to 17.');
        }
