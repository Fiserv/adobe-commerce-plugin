...
/**
 * MastercardAllOf Class Doc Comment
 *
 * @category Class
 * @package  Fiserv\Payments\Lib\CommerceHub
 * @author   OpenAPI Generator team
 ...
 */
class MastercardAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Mastercard_allOf';
    ...
    */
    ...
    public function setXCodeResponse($x_code_response)
    {
        if (!is_null($x_code_response) && (mb_strlen($x_code_response) > 6)) {
            throw new \InvalidArgumentException('invalid length for $x_code_response when calling MastercardAllOf., must be smaller than or equal to 6.');
        }
    ...
    public function setChipCryptoValue($chip_crypto_value)
    {
        if (!is_null($chip_crypto_value) && (mb_strlen($chip_crypto_value) > 3)) {
            throw new \InvalidArgumentException('invalid length for $chip_crypto_value when calling MastercardAllOf., must be smaller than or equal to 3.');
        }
    ...
    public function setCardDataOutputCapability($card_data_output_capability)
    {
        if (!is_null($card_data_output_capability) && (mb_strlen($card_data_output_capability) > 25)) {
            throw new \InvalidArgumentException('invalid length for $card_data_output_capability when calling MastercardAllOf., must be smaller than or equal to 25.');
        }
    ...
    public function setTerminalDataOutputCapability($terminal_data_output_capability)
    {
        if (!is_null($terminal_data_output_capability) && (mb_strlen($terminal_data_output_capability) > 25)) {
            throw new \InvalidArgumentException('invalid length for $terminal_data_output_capability when calling MastercardAllOf., must be smaller than or equal to 25.');
        }
