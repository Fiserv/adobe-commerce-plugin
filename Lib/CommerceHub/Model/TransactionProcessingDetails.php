...
class TransactionProcessingDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['api_key']) && (mb_strlen($this->container['api_key']) > 64)) {
            $invalidProperties[] = "invalid value for 'api_key', the character length must be smaller than or equal to 64.";
        }
    ...
    public function setApiTraceId($api_trace_id)
    {
        ...
        if ((!preg_match("/^[a-f0-9]{32}$/", ObjectSerializer::toString($api_trace_id)))) {
    ...
    public function setClientRequestId($client_request_id)
    {
        ...
        if ((mb_strlen($client_request_id) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $client_request_id when calling TransactionProcessingDetails., must be smaller than or equal to 1024.');
        }
    ...
    public function setTransactionId($transaction_id)
    {
        ...
        if ((mb_strlen($transaction_id) > 40)) {
     ...
     * Sets api_key
     *
     * @param string|null $api_key APIKey from APIGEE as part of Authentication Credentials
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 64)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling TransactionProcessingDetails., must be smaller than or equal to 64.');
        }
