 ...
 *
 * @category Class
 * @description Shipping and/or delivery &lt;a href&#x3D;\&quot;../docs?path&#x3D;docs/Resources/Master-Data/Address.md\&quot;&gt;address&lt;/a&gt; information.
 * @package  Fiserv\Payments\Lib\CommerceHub
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ShippingAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ship_to_email']) && (mb_strlen($this->container['ship_to_email']) > 256)) {
            $invalidProperties[] = "invalid value for 'ship_to_email', the character length must be smaller than or equal to 256.";
        }

        if (!is_null($this->container['shipping_method']) && (mb_strlen($this->container['shipping_method']) > 13)) {
            $invalidProperties[] = "invalid value for 'shipping_method', the character length must be smaller than or equal to 13.";
        }
     ...
     * Sets first_name
     *
     * @param string|null $first_name Shipping contact first name.
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling ShippingAddress., must be smaller than or equal to 256.');
        }
     ...
     * Sets last_name
     *
     * @param string|null $last_name Shipping contact last name.
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling ShippingAddress., must be smaller than or equal to 256.');
        }
     ...
     * Sets ship_to_email
     *
     * @param string|null $ship_to_email Email on a digital delivery transaction.
     *
     * @return self
     */
    public function setShipToEmail($ship_to_email)
    {
        if (!is_null($ship_to_email) && (mb_strlen($ship_to_email) > 256)) {
            throw new \InvalidArgumentException('invalid length for $ship_to_email when calling ShippingAddress., must be smaller than or equal to 256.');
        }
     ...
     *
     * @param string|null $shipping_method Shipping or delivery method.  Valid Values: * SAME_DAY * OVERNIGHT - Next day * PRIORITY - 2-3 days * GROUND - 4 days * ELECTRONIC - Email or digital goods * SHIP_TO_STORE
     *
     * @return self
     */
    public function setShippingMethod($shipping_method)
    {
        if (!is_null($shipping_method) && (mb_strlen($shipping_method) > 13)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method when calling ShippingAddress., must be smaller than or equal to 13.');
        }
