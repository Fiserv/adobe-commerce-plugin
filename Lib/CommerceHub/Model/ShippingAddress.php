...
class ShippingAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['shipping_method']) && (mb_strlen($this->container['shipping_method']) > 60)) {
            $invalidProperties[] = "invalid value for 'shipping_method', the character length must be smaller than or equal to 60.";
        }
     ...
     *
     * @param string|null $shipping_method Shipping or delivery method.
     *
     * @return self
     */
    public function setShippingMethod($shipping_method)
    {
        ...
        if ((mb_strlen($shipping_method) > 60)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method when calling ShippingAddress., must be smaller than or equal to 60.');
        }
    ...
    public function setShipToEmail($ship_to_email)
    {
        ...
        if ((mb_strlen($ship_to_email) > 256)) {
