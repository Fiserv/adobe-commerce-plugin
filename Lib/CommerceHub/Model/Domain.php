...
class Domain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url HTTP domain to be passed for whitelisting
     *
     * @return self
     */
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $url when calling Domain., must be smaller than or equal to 2048.');
        }
