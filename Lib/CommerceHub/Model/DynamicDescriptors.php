...
class DynamicDescriptors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('customer_service_email', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['customer_service_email']) && (mb_strlen($this->container['customer_service_email']) > 256)) {
            $invalidProperties[] = "invalid value for 'customer_service_email', the character length must be smaller than or equal to 256.";
        }
        ...
        if (!is_null($this->container['sub_merchant_id']) && (mb_strlen($this->container['sub_merchant_id']) > 1024)) {
            $invalidProperties[] = "invalid value for 'sub_merchant_id', the character length must be smaller than or equal to 1024.";
        }
     ...
     *
     * @param string|null $customer_service_number Customer service phone number information.
     *
     * @return self
     */
    public function setCustomerServiceNumber($customer_service_number)
    {
        ...
        if ((mb_strlen($customer_service_number) > 15)) {
     ...
     *
     * @param string|null $customer_service_email Customer service email information.
     *
     * @return self
     */
    public function setCustomerServiceEmail($customer_service_email)
    {
        if (is_null($customer_service_email)) {
            throw new \InvalidArgumentException('non-nullable customer_service_email cannot be null');
        }
        if ((mb_strlen($customer_service_email) > 256)) {
            throw new \InvalidArgumentException('invalid length for $customer_service_email when calling DynamicDescriptors., must be smaller than or equal to 256.');
        }
    ...
    public function setServiceEntitlement($service_entitlement)
    {
        ...
        if ((mb_strlen($service_entitlement) > 16)) {
     ...
     *
     * @param string|null $sub_merchant_id Sub-merchant ID defined by a third party processor.
     *
     * @return self
     */
    public function setSubMerchantId($sub_merchant_id)
    {
        ...
        if ((mb_strlen($sub_merchant_id) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $sub_merchant_id when calling DynamicDescriptors., must be smaller than or equal to 1024.');
        }
