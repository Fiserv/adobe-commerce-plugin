 ...
 *
 * @category Class
 * @description Shipper &lt;a href&#x3D;\&quot;../docs?path&#x3D;docs/Resources/Master-Data/Address.md\&quot;&gt;address&lt;/a&gt; information.
 * @package  Fiserv\Payments\Lib\CommerceHub
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ShipperAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipperAddress';
    ...
    */
     ...
     * Sets first_name
     *
     * @param string|null $first_name Shipper contact first name.
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling ShipperAddress., must be smaller than or equal to 256.');
        }
     ...
     * Sets last_name
     *
     * @param string|null $last_name Shipper contact last name.
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling ShipperAddress., must be smaller than or equal to 256.');
        }
