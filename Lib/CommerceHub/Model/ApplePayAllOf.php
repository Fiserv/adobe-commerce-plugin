...
/**
 * ApplePayAllOf Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplePayAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplePay_allOf';
    ...
    */
    ...
    public function setData($data)
    {
        if (!is_null($data) && (mb_strlen($data) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ApplePayAllOf., must be smaller than or equal to 4000.');
        }
    ...
    public function setSignature($signature)
    {
        if (!is_null($signature) && (mb_strlen($signature) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $signature when calling ApplePayAllOf., must be smaller than or equal to 4000.');
        }
    ...
    public function setVersion($version)
    {
        if (!is_null($version) && (mb_strlen($version) > 64)) {
            throw new \InvalidArgumentException('invalid length for $version when calling ApplePayAllOf., must be smaller than or equal to 64.');
        }
    ...
    public function setApplicationData($application_data)
    {
        if (!is_null($application_data) && (mb_strlen($application_data) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $application_data when calling ApplePayAllOf., must be smaller than or equal to 4000.');
        }
    ...
    public function setApplePayMerchantId($apple_pay_merchant_id)
    {
        if (!is_null($apple_pay_merchant_id) && (mb_strlen($apple_pay_merchant_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $apple_pay_merchant_id when calling ApplePayAllOf., must be smaller than or equal to 256.');
        }
    ...
    public function setMerchantPrivateKey($merchant_private_key)
    {
        if (!is_null($merchant_private_key) && (mb_strlen($merchant_private_key) > 256)) {
            throw new \InvalidArgumentException('invalid length for $merchant_private_key when calling ApplePayAllOf., must be smaller than or equal to 256.');
        }
