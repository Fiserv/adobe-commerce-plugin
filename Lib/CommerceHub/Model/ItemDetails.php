...
class ItemDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['category_name']) && (mb_strlen($this->container['category_name']) > 8)) {
            $invalidProperties[] = "invalid value for 'category_name', the character length must be smaller than or equal to 8.";
        }
     ...
     * Sets category_name
     *
     * @param string|null $category_name Merchant defined category of the item(s) sold
     *
     * @return self
     */
    public function setCategoryName($category_name)
    {
        if (!is_null($category_name) && (mb_strlen($category_name) > 8)) {
            throw new \InvalidArgumentException('invalid length for $category_name when calling ItemDetails., must be smaller than or equal to 8.');
        }
     ...
     * Sets item_count
     *
     * @param int|null $item_count The item count in category.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param float|null $value The monetary value of items.
     *
     * @return self
     */
