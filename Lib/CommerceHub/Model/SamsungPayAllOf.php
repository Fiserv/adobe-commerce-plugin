...
/**
 * SamsungPayAllOf Class Doc Comment
 *
 * @category Class
 * @package  Fiserv\Payments\Lib\CommerceHub
 * @author   OpenAPI Generator team
 ...
 */
class SamsungPayAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SamsungPay_allOf';
    ...
    */
    ...
    public function setSamsungPayMerchantId($samsung_pay_merchant_id)
    {
        if (!is_null($samsung_pay_merchant_id) && (mb_strlen($samsung_pay_merchant_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $samsung_pay_merchant_id when calling SamsungPayAllOf., must be smaller than or equal to 256.');
        }
    ...
    public function setMerchantPrivateKey($merchant_private_key)
    {
        if (!is_null($merchant_private_key) && (mb_strlen($merchant_private_key) > 256)) {
            throw new \InvalidArgumentException('invalid length for $merchant_private_key when calling SamsungPayAllOf., must be smaller than or equal to 256.');
        }
