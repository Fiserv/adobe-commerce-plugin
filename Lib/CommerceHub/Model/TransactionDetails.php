 ...
 *
 * The version of the OpenAPI document: v1.25.1800
...
class TransactionDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'retailer_indicator' => 'retailerIndicator'
    ];
    ...
    protected static $setters = [
        ...
        'token_provider' => 'setTokenProvider',
        'provider_session_id' => 'setProviderSessionId',
        ...
        'retailer_indicator' => 'setRetailerIndicator'
    ];
    ...
    protected static $getters = [
        ...
        'token_provider' => 'getTokenProvider',
        'provider_session_id' => 'getProviderSessionId',
        ...
        'retailer_indicator' => 'getRetailerIndicator'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('token_provider', $data ?? [], null);
        $this->setIfExists('provider_session_id', $data ?? [], null);
        ...
        $this->setIfExists('retailer_indicator', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['token_provider']) && (mb_strlen($this->container['token_provider']) > 256)) {
            $invalidProperties[] = "invalid value for 'token_provider', the character length must be smaller than or equal to 256.";
        }

        if (!is_null($this->container['provider_session_id']) && (mb_strlen($this->container['provider_session_id']) > 256)) {
            $invalidProperties[] = "invalid value for 'provider_session_id', the character length must be smaller than or equal to 256.";
        }
        ...
        if (!is_null($this->container['retailer_indicator']) && (mb_strlen($this->container['retailer_indicator']) > 20)) {
            $invalidProperties[] = "invalid value for 'retailer_indicator', the character length must be smaller than or equal to 20.";
        }
     ...
     * Sets capture_flag
     *
     * @param bool|null $capture_flag Designates if the transaction should be captured. Set to false for authorization or true for capture. If not provided in a charges or refunds request, it defaults to true.
     *
     * @return self
     */
     ...
     *
     * @param \Fiserv\Payments\Lib\CommerceHub\Model\DeviceFingerPrint[]|null $device_fingerprint <a href=\"../docs?path=docs/Resources/Master-Data/Device-Fingerprint.md\">Device fingerprint</a> details for mobile and browser transactions.
     *
     * @return self
     */
    ...
    {
        return $this->container['token_provider'];
    }

    /**
     * Sets token_provider
     *
     * @param string|null $token_provider Source for the Token Service Provider (TSP).
     *
     * @return self
     */
    public function setTokenProvider($token_provider)
    {
        if (is_null($token_provider)) {
            throw new \InvalidArgumentException('non-nullable token_provider cannot be null');
        }
        if ((mb_strlen($token_provider) > 256)) {
            throw new \InvalidArgumentException('invalid length for $token_provider when calling TransactionDetails., must be smaller than or equal to 256.');
        }

        $this->container['token_provider'] = $token_provider;

        return $this;
    }

    /**
     * Gets provider_session_id
     *
     * @return string|null
     */
    public function getProviderSessionId()
    {
        return $this->container['provider_session_id'];
    }

    /**
     * Sets provider_session_id
     *
     * @param string|null $provider_session_id Session Id for Token Provider.
     *
     * @return self
     */
    public function setProviderSessionId($provider_session_id)
    {
        if (is_null($provider_session_id)) {
            throw new \InvalidArgumentException('non-nullable provider_session_id cannot be null');
        }
        if ((mb_strlen($provider_session_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $provider_session_id when calling TransactionDetails., must be smaller than or equal to 256.');
        }

        $this->container['provider_session_id'] = $provider_session_id;
     ...
     *
     * @param string|null $processing_code A required <a href=\"../docs?path=docs/Resources/Master-Data/Processing-Code.md\">code</a> is used in conjunction with the message type to define the type of transaction that is by the terminal to the host.
     *
     * @return self
     */
    ...
    /**
     * Gets retailer_indicator
     *
     * @return string|null
     */
    public function getRetailerIndicator()
    {
        return $this->container['retailer_indicator'];
    }

    /**
     * Sets retailer_indicator
     *
     * @param string|null $retailer_indicator This indicator is used to uniquely identify foreign retailer transactions in the response.
     *
     * @return self
     */
    public function setRetailerIndicator($retailer_indicator)
    {
        if (is_null($retailer_indicator)) {
            throw new \InvalidArgumentException('non-nullable retailer_indicator cannot be null');
        }
        if ((mb_strlen($retailer_indicator) > 20)) {
            throw new \InvalidArgumentException('invalid length for $retailer_indicator when calling TransactionDetails., must be smaller than or equal to 20.');
        }

        $this->container['retailer_indicator'] = $retailer_indicator;
