 ...
 */
class Discover extends Network
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Discover';
    ...
    */
    ...
    public function setNetworkOriginalAmount($network_original_amount)
    {
        ...
        if (!is_null($network_original_amount) && ($network_original_amount > 1.0E+18)) {
            throw new \InvalidArgumentException('invalid value for $network_original_amount when calling Discover., must be smaller than or equal to 1.0E+18.');
        }
