...
class ChargesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'provider_credentials' => '\Fiserv\Payments\Lib\CommerceHub\Model\ProviderCredential[]',
        ...
        'posted_balance' => '\Fiserv\Payments\Lib\CommerceHub\Model\Balance'
    ];
    ...
    protected static $setters = [
        ...
        'posted_balance' => 'setPostedBalance'
    ];
    ...
    protected static $getters = [
        ...
        'posted_balance' => 'getPostedBalance'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('provider_credentials', $data ?? [], null);
        ...
        $this->setIfExists('posted_balance', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \Fiserv\Payments\Lib\CommerceHub\Model\ProviderCredential[]|null
     */
     ...
     *
     * @param \Fiserv\Payments\Lib\CommerceHub\Model\ProviderCredential[]|null $provider_credentials provider_credentials
     *
     * @return self
     */
    public function setProviderCredentials($provider_credentials)
    {
        if (is_null($provider_credentials)) {
            throw new \InvalidArgumentException('non-nullable provider_credentials cannot be null');
        }
     ...
     *
     * @param \Fiserv\Payments\Lib\CommerceHub\Model\SplitSettlement[]|null $split_settlement <a href=\"../docs?path=docs/Resources/Guides/Partners/PFAC/Split-Settlement.md#tab-splitsettlement\">Split settlement </a> information that is used to split payouts of a transaction into multiple accounts.
     *
     * @return self
     */
    ...
    {
        return $this->container['posted_balance'];
    }

    /**
     * Sets posted_balance
     *
     * @param \Fiserv\Payments\Lib\CommerceHub\Model\Balance|null $posted_balance posted_balance
     *
     * @return self
     */
    public function setPostedBalance($posted_balance)
    {
        if (is_null($posted_balance)) {
            throw new \InvalidArgumentException('non-nullable posted_balance cannot be null');
        }
        $this->container['posted_balance'] = $posted_balance;
