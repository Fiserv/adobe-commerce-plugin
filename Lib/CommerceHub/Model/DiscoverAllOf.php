...
/**
 * DiscoverAllOf Class Doc Comment
 *
 * @category Class
 * @package  Fiserv\Payments\Lib\CommerceHub
 * @author   OpenAPI Generator team
 ...
 */
class DiscoverAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Discover_allOf';
    ...
    */
     ...
     *
     * @param float|null $network_original_amount Original transaction amount, required for Discover card on file transactions.
     *
     * @return self
     */
    public function setNetworkOriginalAmount($network_original_amount)
    {
        ...
        if (!is_null($network_original_amount) && ($network_original_amount > 1.0E+18)) {
            throw new \InvalidArgumentException('invalid value for $network_original_amount when calling DiscoverAllOf., must be smaller than or equal to 1.0E+18.');
        }
