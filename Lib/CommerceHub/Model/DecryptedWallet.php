...
/**
 * DecryptedWallet Class Doc Comment
 *
 * @category Class
 * @package  Fiserv\Payments\Lib\CommerceHub
 * @author   OpenAPI Generator team
 ...
 */
class DecryptedWallet extends Source
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DecryptedWallet';
    ...
    */
    ...
    public function setCavv($cavv)
    {
        ...
        if ((mb_strlen($cavv) > 40)) {
            throw new \InvalidArgumentException('invalid length for $cavv when calling DecryptedWallet., must be smaller than or equal to 40.');
        }
    ...
    public function setXid($xid)
    {
        ...
        if ((mb_strlen($xid) > 40)) {
            throw new \InvalidArgumentException('invalid length for $xid when calling DecryptedWallet., must be smaller than or equal to 40.');
        }
    ...
    public function setWalletType($wallet_type)
    {
        ...
        if ((mb_strlen($wallet_type) > 256)) {
            throw new \InvalidArgumentException('invalid length for $wallet_type when calling DecryptedWallet., must be smaller than or equal to 256.');
        }
