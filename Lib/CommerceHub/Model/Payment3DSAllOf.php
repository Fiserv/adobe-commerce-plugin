...
/**
 * Payment3DSAllOf Class Doc Comment
 *
 * @category Class
 ...
 */
class Payment3DSAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payment3DS_allOf';
    ...
    */
    ...
    public function setMerchantIdentifier($merchant_identifier)
    {
        if (!is_null($merchant_identifier) && (mb_strlen($merchant_identifier) > 256)) {
            throw new \InvalidArgumentException('invalid length for $merchant_identifier when calling Payment3DSAllOf., must be smaller than or equal to 256.');
        }
    ...
    public function setVersion($version)
    {
        if (!is_null($version) && (mb_strlen($version) > 64)) {
            throw new \InvalidArgumentException('invalid length for $version when calling Payment3DSAllOf., must be smaller than or equal to 64.');
        }
    ...
    public function setCavv($cavv)
    {
        if (!is_null($cavv) && (mb_strlen($cavv) > 256)) {
            throw new \InvalidArgumentException('invalid length for $cavv when calling Payment3DSAllOf., must be smaller than or equal to 256.');
        }
    ...
    public function setXid($xid)
    {
        if (!is_null($xid) && (mb_strlen($xid) > 256)) {
            throw new \InvalidArgumentException('invalid length for $xid when calling Payment3DSAllOf., must be smaller than or equal to 256.');
        }
    ...
    public function setVerificationResponse($verification_response)
    {
        if (!is_null($verification_response) && (mb_strlen($verification_response) > 256)) {
            throw new \InvalidArgumentException('invalid length for $verification_response when calling Payment3DSAllOf., must be smaller than or equal to 256.');
        }
    ...
    public function setAuthenticationAttemptResult($authentication_attempt_result)
    {
        if (!is_null($authentication_attempt_result) && (mb_strlen($authentication_attempt_result) > 256)) {
            throw new \InvalidArgumentException('invalid length for $authentication_attempt_result when calling Payment3DSAllOf., must be smaller than or equal to 256.');
        }
    ...
    public function setChannel($channel)
    {
        if (!is_null($channel) && (mb_strlen($channel) > 32)) {
            throw new \InvalidArgumentException('invalid length for $channel when calling Payment3DSAllOf., must be smaller than or equal to 32.');
        }
