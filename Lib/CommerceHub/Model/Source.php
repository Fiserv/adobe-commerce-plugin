...
class Source implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['source_type']) > 256)) {
            $invalidProperties[] = "invalid value for 'source_type', the character length must be smaller than or equal to 256.";
        }
