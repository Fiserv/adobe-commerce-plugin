...
/**
 * SplitTender Class Doc Comment
 *
 * @category Class
 * @description &lt;a href&#x3D;\&quot;../docs?path&#x3D;docs/Resources/Guides/Split-Tender.md\&quot;&gt;Split tender&lt;/a&gt; information passed during a transaction request.
 * @package  Fiserv\Payments\Lib\CommerceHub
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SplitTender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SplitTender';
    ...
    protected static $openAPITypes = [
        ...
        'split_tender_method' => '\Fiserv\Payments\Lib\CommerceHub\Model\SplitTenderMethod[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'split_tender_method' => 'splitTenderMethod'
    ];
    ...
    protected static $setters = [
        ...
        'split_tender_method' => 'setSplitTenderMethod'
    ];
    ...
    protected static $getters = [
        ...
        'split_tender_method' => 'getSplitTenderMethod'
    ];
    ...
    */
    ...
    public function setSplitTenderId($split_tender_id)
    {
        ...
        if ((mb_strlen($split_tender_id) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $split_tender_id when calling SplitTender., must be smaller than or equal to 1024.');
        }
    ...
    /**
     * Gets split_tender_method
     *
     * @return \Fiserv\Payments\Lib\CommerceHub\Model\SplitTenderMethod[]|null
     */
    public function getSplitTenderMethod()
    {
        return $this->container['split_tender_method'];
    }

    /**
     * Sets split_tender_method
     *
     * @param \Fiserv\Payments\Lib\CommerceHub\Model\SplitTenderMethod[]|null $split_tender_method split_tender_method
     *
     * @return self
     */
    public function setSplitTenderMethod($split_tender_method)
    {
        if (is_null($split_tender_method)) {
            throw new \InvalidArgumentException('non-nullable split_tender_method cannot be null');
        }
        $this->container['split_tender_method'] = $split_tender_method;
