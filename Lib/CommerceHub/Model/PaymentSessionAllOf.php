...
/**
 * PaymentSessionAllOf Class Doc Comment
 *
 * @category Class
 * @package  Fiserv\Payments\Lib\CommerceHub
 * @author   OpenAPI Generator team
 ...
 */
class PaymentSessionAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentSession_allOf';
    ...
    */
    ...
    public function setSessionId($session_id)
    {
        if (!is_null($session_id) && (mb_strlen($session_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $session_id when calling PaymentSessionAllOf., must be smaller than or equal to 64.');
        }
