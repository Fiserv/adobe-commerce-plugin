...
/**
 * FraudAttributes Class Doc Comment
 *
 * @category Class
 ...
 */
class FraudAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FraudAttributes';
    ...
    */
     ...
     * Sets risk_score
     *
     * @param int|null $risk_score Merchant's defined fraud risk score for this transaction 0-100, 100 being highest risk.
     *
     * @return self
     */
    public function setRiskScore($risk_score)
    {
        ...
        if (($risk_score > 100)) {
            throw new \InvalidArgumentException('invalid value for $risk_score when calling FraudAttributes., must be smaller than or equal to 100.');
        }
     ...
     * Sets suspicious
     *
     * @param bool|null $suspicious If the merchant detected suspicious activity on card, account or device used for this transaction in prior 60 days.
     *
     * @return self
     */
