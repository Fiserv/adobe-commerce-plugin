...
class AccountDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name An account name for split settlement.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountDetails., must be smaller than or equal to 1024.');
        }
     ...
     * Sets type
     *
     * @param string|null $type Type of split settlement account.
     *
     * @return self
     */
