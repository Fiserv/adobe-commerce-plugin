...
/**
 * MyReturnScoreDetailsAllOf Class Doc Comment
 *
 * @category Class
 * @package  Fiserv\Payments\Lib\CommerceHub
 * @author   OpenAPI Generator team
 ...
 */
class MyReturnScoreDetailsAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MyReturnScoreDetails_allOf';
    ...
    */
    ...
    public function setScore($score)
    {
        ...
        if (!is_null($score) && ($score > 100)) {
            throw new \InvalidArgumentException('invalid value for $score when calling MyReturnScoreDetailsAllOf., must be smaller than or equal to 100.');
        }
        if (!is_null($score) && ($score < 0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling MyReturnScoreDetailsAllOf., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $return_probability_profile Bucketed return probability profile  Valid Values: * High * Low
     *
     * @return self
     */
