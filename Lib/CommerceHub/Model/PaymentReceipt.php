...
class PaymentReceipt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (!is_null($merchant_address) && (mb_strlen($merchant_address) > 1024)) {
    ...
    {
        if (!is_null($merchant_city) && (mb_strlen($merchant_city) > 256)) {
    ...
    {
        if (!is_null($merchant_state_or_province) && (mb_strlen($merchant_state_or_province) > 256)) {
    ...
    {
        if (!is_null($merchant_country) && (mb_strlen($merchant_country) > 256)) {
    ...
    {
        if (!is_null($merchant_url) && (mb_strlen($merchant_url) > 256)) {
    ...
    {
        if (!is_null($merchant_postal_code) && (mb_strlen($merchant_postal_code) > 10)) {
