...
class Installments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['invoice_date']) && (mb_strlen($this->container['invoice_date']) > 10)) {
            $invalidProperties[] = "invalid value for 'invoice_date', the character length must be smaller than or equal to 10.";
        }
    ...
    public function setInstallmentAmount($installment_amount)
    {
        ...
        if (!is_null($installment_amount) && ($installment_amount > 1.0E+18)) {
    ...
    public function setLastInstallmentAmount($last_installment_amount)
    {
        ...
        if (!is_null($last_installment_amount) && ($last_installment_amount > 1.0E+18)) {
    ...
    public function setInstallmentCount($installment_count)
    {
        ...
        if (!is_null($installment_count) && ($installment_count > 999)) {
    ...
    public function setInterestRate($interest_rate)
    {
        ...
        if (!is_null($interest_rate) && ($interest_rate > 100)) {
    ...
    public function setPaymentFirstDay($payment_first_day)
    {
        ...
        if (!is_null($payment_first_day) && ($payment_first_day > 1.0E+18)) {
    ...
    {
        if (!is_null($invoice_id) && (mb_strlen($invoice_id) > 256)) {
    ...
    {
        if (!is_null($invoice_date) && (mb_strlen($invoice_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $invoice_date when calling Installments., must be smaller than or equal to 10.');
        }
    ...
    {
        if (!is_null($delivery_date) && (mb_strlen($delivery_date) > 10)) {
    ...
    {
        if (!is_null($due_date) && (mb_strlen($due_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $due_date when calling Installments., must be smaller than or equal to 10.');
        }
