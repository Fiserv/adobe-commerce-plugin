 ...
 */
class KeyDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets key_id
     *
     * @param string|null $key_id Key ID is provided to get the corresponding RSA public key.
     *
     * @return self
     */
    public function setKeyId($key_id)
    {
        ...
        if ((mb_strlen($key_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $key_id when calling KeyDetails., must be smaller than or equal to 64.');
        }
     ...
     *
     * @param string|null $encryption_type Encryption type to be passed. Possible values: RSA, Verifone, TDES/DUKPT,On-Guard FPE, AES/Dukpt. Defaults to RSA
     *
     * @return self
     */
    public function setEncryptionType($encryption_type)
    {
        ...
        if ((mb_strlen($encryption_type) > 32)) {
            throw new \InvalidArgumentException('invalid length for $encryption_type when calling KeyDetails., must be smaller than or equal to 32.');
        }
     ...
     *
     * @param string|null $encoded_public_key Encoded public key.
     *
     * @return self
     */
