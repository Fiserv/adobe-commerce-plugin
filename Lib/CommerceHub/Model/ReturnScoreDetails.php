...
/**
 * ReturnScoreDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class ReturnScoreDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReturnScoreDetails';
    ...
    */
    ...
    public function setPercentSalesReturned($percent_sales_returned)
    {
        ...
        if (!is_null($percent_sales_returned) && ($percent_sales_returned > 1)) {
            throw new \InvalidArgumentException('invalid value for $percent_sales_returned when calling ReturnScoreDetails., must be smaller than or equal to 1.');
        }
        if (!is_null($percent_sales_returned) && ($percent_sales_returned < 0)) {
            throw new \InvalidArgumentException('invalid value for $percent_sales_returned when calling ReturnScoreDetails., must be bigger than or equal to 0.');
        }
