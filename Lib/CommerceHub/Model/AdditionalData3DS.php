...
class AdditionalData3DS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'authentication_transaction_id' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('authentication_transaction_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['authentication_transaction_id']) && (mb_strlen($this->container['authentication_transaction_id']) > 40)) {
            $invalidProperties[] = "invalid value for 'authentication_transaction_id', the character length must be smaller than or equal to 40.";
        }
        ...
        if (!is_null($this->container['sca_exemption']) && (mb_strlen($this->container['sca_exemption']) > 32)) {
            $invalidProperties[] = "invalid value for 'sca_exemption', the character length must be smaller than or equal to 32.";
        }
     ...
     *
     * @param string|null $authentication_transaction_id Unique identifier for each authentication transaction on the gateway, used for reference in a subsequent transaction.
     *
     * @return self
     */
    public function setAuthenticationTransactionId($authentication_transaction_id)
    {
        if (is_null($authentication_transaction_id)) {
            throw new \InvalidArgumentException('non-nullable authentication_transaction_id cannot be null');
        }
        if ((mb_strlen($authentication_transaction_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $authentication_transaction_id when calling AdditionalData3DS., must be smaller than or equal to 40.');
        }
     ...
     * Sets sca_exemption
     *
     * @param string|null $sca_exemption SCA exemption type used in payment authorization transaction.
     *
     * @return self
     */
    public function setScaExemption($sca_exemption)
    {
        ...
        if ((mb_strlen($sca_exemption) > 32)) {
            throw new \InvalidArgumentException('invalid length for $sca_exemption when calling AdditionalData3DS., must be smaller than or equal to 32.');
        }
