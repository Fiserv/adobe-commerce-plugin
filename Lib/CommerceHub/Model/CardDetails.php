...
class CardDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets bin_source
     *
     * @param string|null $bin_source Categorizes the source of the BIN record.  Valid Values: * FISERV - (Default) Fiserv Global BIN file * CHASE - Chase BIN file(s) * PRIVATE_LABEL - Private Label specific BIN (availability restricted per merchant)
     *
     * @return self
     */
    public function setBinSource($bin_source)
    {
        if (!is_null($bin_source) && (mb_strlen($bin_source) > 30)) {
     ...
     * Sets record_type
     *
     * @param string|null $record_type Record Type  Valid Values: * DETAIL - Detail Record
     *
     * @return self
     */
    public function setRecordType($record_type)
    {
        if (!is_null($record_type) && (mb_strlen($record_type) > 10)) {
    ...
    {
        if (!is_null($low_bin) && (mb_strlen($low_bin) > 21)) {
    ...
    {
        if (!is_null($high_bin) && (mb_strlen($high_bin) > 21)) {
    ...
    {
        if (!is_null($bin_length) && (mb_strlen($bin_length) > 2)) {
    ...
    {
        if (!is_null($bin_detail_pan) && (mb_strlen($bin_detail_pan) > 2)) {
    ...
    {
        if (!is_null($issuer_bank_name) && (mb_strlen($issuer_bank_name) > 100)) {
     ...
     * Sets country_code
     *
     * @param string|null $country_code ISO-3166-1 alpha-3 country code.
     *
     * @return self
     */
     ...
     *
     * @param string|null $detailed_card_product Card Product.  Valid Values: * VISA - Visa * MASTERCARD - Mastercard * AMEX - American Express * DISCOVER - Discover * PIN_ONLY - PIN Only (Not Visa, Mastercard, American Express, Discover) * MAESTRO - International Maestro * DINERS - Diners Club * INTERAC - Interac * JCB - JCB
     *
     * @return self
     */
    public function setDetailedCardProduct($detailed_card_product)
    {
        if (!is_null($detailed_card_product) && (mb_strlen($detailed_card_product) > 21)) {
     ...
     *
     * @param string|null $detailed_card_indicator Determines the card type (credit, debit).  Valid Values: * CREDIT * DEBIT * COMMERCIAL_DEBIT * CONSUMER_DEBIT
     *
     * @return self
     */
    public function setDetailedCardIndicator($detailed_card_indicator)
    {
        if (!is_null($detailed_card_indicator) && (mb_strlen($detailed_card_indicator) > 16)) {
     ...
     *
     * @param string|null $pin_signature_capability Determines the card PIN/Signature capability.  Valid Values: * PIN_CAPABLE - PIN Capable * SIGNATURE - Signature Capable * PIN_OR_SIGNATURE - Supports Both PIN or Signature
     *
     * @return self
     */
    public function setPinSignatureCapability($pin_signature_capability)
    {
        if (!is_null($pin_signature_capability) && (mb_strlen($pin_signature_capability) > 16)) {
    ...
    {
        if (!is_null($issuer_update_year) && (mb_strlen($issuer_update_year) > 2)) {
    ...
    {
        if (!is_null($issuer_update_month) && (mb_strlen($issuer_update_month) > 2)) {
    ...
    {
        if (!is_null($issuer_update_day) && (mb_strlen($issuer_update_day) > 2)) {
     ...
     *
     * @param string|null $regulator_indicator Applies to US issued cards only (Visa, Mastercard, and Discover).  Valid Values: * NON_REGULATED - (Default) ISS non-regulated (unregulated issuer OR Non US issued card) * REGULATED - ISS regulated (regulated issuer) * REGULATED_FRAUD - ISS regulated fraud (regulated issuer with fraud)
     *
     * @return self
     */
    public function setRegulatorIndicator($regulator_indicator)
    {
        if (!is_null($regulator_indicator) && (mb_strlen($regulator_indicator) > 15)) {
     ...
     * Sets card_class
     *
     * @param string|null $card_class Categorizes the BIN as a Business card, Corporate T&E card, Purchase card or Consumer card.  Valid Values: * BUSINESS * CONSUMER * PURCHASE * CORPORATE
     *
     * @return self
     */
    public function setCardClass($card_class)
    {
        if (!is_null($card_class) && (mb_strlen($card_class) > 30)) {
    ...
    {
        if (!is_null($ebt_state) && (mb_strlen($ebt_state) > 2)) {
     ...
     * Sets fsa_indicator
     *
     * @param string|null $fsa_indicator FSA/HSA (Flexible Spending Account / Health Savings Account) indicator, which denotes prepaid card program in the US that permits use of funds to pay for qualified out of pocket medical expenses.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setFsaIndicator($fsa_indicator)
    {
        if (!is_null($fsa_indicator) && (mb_strlen($fsa_indicator) > 13)) {
     ...
     *
     * @param string|null $non_money_transfer_octs_domestic Indicates if domestic non-money transfer OCTs are supported. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setNonMoneyTransferOctsDomestic($non_money_transfer_octs_domestic)
    {
        if (!is_null($non_money_transfer_octs_domestic) && (mb_strlen($non_money_transfer_octs_domestic) > 13)) {
     ...
     *
     * @param string|null $non_money_transfer_octs_cross_border Indicates if cross-border non-money transfer OCTs are supported. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setNonMoneyTransferOctsCrossBorder($non_money_transfer_octs_cross_border)
    {
        if (!is_null($non_money_transfer_octs_cross_border) && (mb_strlen($non_money_transfer_octs_cross_border) > 13)) {
     ...
     *
     * @param string|null $online_gambling_octs_domestic Indicates if domestic online gambling OCTs are supported. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setOnlineGamblingOctsDomestic($online_gambling_octs_domestic)
    {
        if (!is_null($online_gambling_octs_domestic) && (mb_strlen($online_gambling_octs_domestic) > 13)) {
     ...
     *
     * @param string|null $online_gambling_octs_cross_border Indicates if cross-border online gambling OCTs are supported. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setOnlineGamblingOctsCrossBorder($online_gambling_octs_cross_border)
    {
        if (!is_null($online_gambling_octs_cross_border) && (mb_strlen($online_gambling_octs_cross_border) > 13)) {
     ...
     *
     * @param string|null $money_transfer_octs_domestic Indicates if domestic money transfer OCTs are supported. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setMoneyTransferOctsDomestic($money_transfer_octs_domestic)
    {
        if (!is_null($money_transfer_octs_domestic) && (mb_strlen($money_transfer_octs_domestic) > 13)) {
     ...
     *
     * @param string|null $money_transfer_octs_cross_border Indicates if cross-border money transfer OCTs are supported. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setMoneyTransferOctsCrossBorder($money_transfer_octs_cross_border)
    {
        if (!is_null($money_transfer_octs_cross_border) && (mb_strlen($money_transfer_octs_cross_border) > 13)) {
     ...
     *
     * @param string|null $fast_funds_domestic_money_transfer Indicates if fast funds is supported for domestic money transfer OCTs. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setFastFundsDomesticMoneyTransfer($fast_funds_domestic_money_transfer)
    {
        if (!is_null($fast_funds_domestic_money_transfer) && (mb_strlen($fast_funds_domestic_money_transfer) > 13)) {
     ...
     *
     * @param string|null $fast_funds_cross_border_money_transfer Indicates if fast funds is supported for cross-border money transfer OCTs. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setFastFundsCrossBorderMoneyTransfer($fast_funds_cross_border_money_transfer)
    {
        if (!is_null($fast_funds_cross_border_money_transfer) && (mb_strlen($fast_funds_cross_border_money_transfer) > 13)) {
     ...
     *
     * @param string|null $fast_funds_domestic_non_money_transfer Indicates if fast funds is supported for domestic non-money transfer OCTs. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setFastFundsDomesticNonMoneyTransfer($fast_funds_domestic_non_money_transfer)
    {
        if (!is_null($fast_funds_domestic_non_money_transfer) && (mb_strlen($fast_funds_domestic_non_money_transfer) > 13)) {
     ...
     *
     * @param string|null $fast_funds_cross_border_non_money_transfer Indicates if fast funds is supported for cross-border non-money transfer OCTs. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setFastFundsCrossBorderNonMoneyTransfer($fast_funds_cross_border_non_money_transfer)
    {
        if (!is_null($fast_funds_cross_border_non_money_transfer) && (mb_strlen($fast_funds_cross_border_non_money_transfer) > 13)) {
     ...
     *
     * @param string|null $fast_funds_domestic_gambling Indicates if fast funds is supported for domestic gambling OCTs. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setFastFundsDomesticGambling($fast_funds_domestic_gambling)
    {
        if (!is_null($fast_funds_domestic_gambling) && (mb_strlen($fast_funds_domestic_gambling) > 13)) {
     ...
     *
     * @param string|null $fast_funds_cross_border_gambling Indicates if fast funds is supported for cross-border gambling OCTs. Visa Only.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setFastFundsCrossBorderGambling($fast_funds_cross_border_gambling)
    {
        if (!is_null($fast_funds_cross_border_gambling) && (mb_strlen($fast_funds_cross_border_gambling) > 13)) {
     ...
     *
     * @param string|null $prepaid_indicator Indicates whether the card is prepaid.  Valid Values: * NON_PREPAID - (Default) No / Not Supported * PREPAID - Yes / Supported
     *
     * @return self
     */
    public function setPrepaidIndicator($prepaid_indicator)
    {
        if (!is_null($prepaid_indicator) && (mb_strlen($prepaid_indicator) > 13)) {
    ...
    {
        if (!is_null($product_id) && (mb_strlen($product_id) > 5)) {
    ...
    {
        if (!is_null($visa_product_sub_type) && (mb_strlen($visa_product_sub_type) > 2)) {
     ...
     *
     * @param string|null $visa_large_ticket_indicator Visa large ticket indicator.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setVisaLargeTicketIndicator($visa_large_ticket_indicator)
    {
        if (!is_null($visa_large_ticket_indicator) && (mb_strlen($visa_large_ticket_indicator) > 13)) {
     ...
     *
     * @param string|null $account_fund_source For Visa, Mastercard, Discover, and UnionPay. Identifies the source of the funds associated with the primary account for the card.  Valid Values: * CREDIT - Credit * DEBIT - Debit * PREPAID - Prepaid * CHARGE - Charge * DEFERRED_DEBIT - Deferred Debit (Visa ONLY)
     *
     * @return self
     */
    public function setAccountFundSource($account_fund_source)
    {
        if (!is_null($account_fund_source) && (mb_strlen($account_fund_source) > 15)) {
    ...
    {
        if (!is_null($pan_length_min) && (mb_strlen($pan_length_min) > 2)) {
    ...
    {
        if (!is_null($pan_length_max) && (mb_strlen($pan_length_max) > 2)) {
     ...
     *
     * @param string|null $token_indicator Token indicator.  Valid Values: * NOT_SUPPORTED - (Default) No / Not Supported * SUPPORTED - Yes / Supported
     *
     * @return self
     */
    public function setTokenIndicator($token_indicator)
    {
        if (!is_null($token_indicator) && (mb_strlen($token_indicator) > 13)) {
     ...
     *
     * @param string|null $issuing_network Identifies Discover card types.  Valid Values: * DISCOVER - Discover * DINERS - Diners * JCB - JCB (Japanese Credit Bank) * CUP - CUP (China Union Pay) * PAYPAL - PayPal
     *
     * @return self
     */
    public function setIssuingNetwork($issuing_network)
    {
        if (!is_null($issuing_network) && (mb_strlen($issuing_network) > 10)) {
     ...
     *
     * @param string|null $cardholder_billing_currency Cardholder billing currency in 3-letter ISO currency format.
     *
     * @return self
     */
    public function setCardholderBillingCurrency($cardholder_billing_currency)
    {
        if (!is_null($cardholder_billing_currency) && (mb_strlen($cardholder_billing_currency) > 3)) {
     ...
     *
     * @param string|null $account_fund_source_subtype Account fund source subtype. Mastercard only.  Valid Values: * PREPAID_RELOADABLE - Prepaid card is reloadable * PREPAID_NON_RELOADABLE - Prepaid card is non-reloadable
     *
     * @return self
     */
    public function setAccountFundSourceSubtype($account_fund_source_subtype)
    {
        if (!is_null($account_fund_source_subtype) && (mb_strlen($account_fund_source_subtype) > 22)) {
     ...
     * Sets b2b_program_id
     *
     * @param string|null $b2b_program_id Business-to-Business Virtual Payments Product Offering. Visa only.  Valid Values: * B2B_PROGRAM_1 - B2B Program 1 * B2B_PROGRAM_2 - B2B Program 2 * B2B_PROGRAM_3 - B2B Program 3 * B2B_PROGRAM_4 - B2B Program 4 * B2B_PROGRAM_5 - B2B Program 5 * B2B_PROGRAM_6 - B2B Program 6
     *
     * @return self
     */
    public function setB2bProgramId($b2b_program_id)
    {
        if (!is_null($b2b_program_id) && (mb_strlen($b2b_program_id) > 15)) {
     ...
     *
     * @param string|null $money_send_indicator MoneySend is a set of a Mastercard network transactions that facilitate fund transfers. This indicator determines if the Mastercard account is eligible to receive a MoneySend payment.  Valid Values: * UNKNOWN - (Default) MoneySend unknown * DOMESTIC_AND_CROSS_BORDER - MoneySend enabled Domestic and Cross-Border * DOMESTIC - MoneySend enabled Domestic only * NOT_ENABLED - NOT MoneySend enabled
     *
     * @return self
     */
    public function setMoneySendIndicator($money_send_indicator)
    {
        if (!is_null($money_send_indicator) && (mb_strlen($money_send_indicator) > 25)) {
